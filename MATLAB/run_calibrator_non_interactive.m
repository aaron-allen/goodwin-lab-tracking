...
cellfun(@(vid,calibfilename) error_handling_wrapper([OutputDirectory '/' FileName '/Logs/calibration_errors.log'],'calibrator_non_interactive',char(vid),char(calibfilename)),videonames,calibfilenames,'UniformOutput',false);

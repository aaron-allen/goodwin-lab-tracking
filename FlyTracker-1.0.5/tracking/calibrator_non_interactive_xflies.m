...
function success = calibrator_non_interactive_xflies(f_vid, f_calib)
...
function init_interface()
    ...
    % editable ruler
    ruler_h = imline(sub_h,[im_width/2-255 im_height/2-200; im_width/2+40 im_height/2-200]);
    setColor(ruler_h,'r')
    ...
    h_ruler_len = uicontrol('Style', 'edit', 'String', '20', ...
        'Position', [text_x+margin_x2 text_y 56 22], ...
        'HorizontalAlignment', 'center', ...
        'BackgroundColor','w',...
        'FontSize',fs*12,...
...
function setResolution2(~,~) 
    ...
    vars.total_n_flies = median(blob_count);
    set(handles.h_n_flies,'String',num2str(round(vars.total_n_flies/size(find(calib.valid_chambers),2))));
   % set(handles.h_n_flies,'String',num2str(vars.total_n_flies)); 
    set(handles.h_n_chambers,'String','20');

...
# files in the /mnt/data/videos/ directory and ranks by modification date (oldest to newest).
...
then
    ...
    printf "Below the limit, so not deleting anything.\n\n\n"
fi

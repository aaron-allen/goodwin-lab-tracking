...
for fly = 1:nflies
    trxfiledata.trx(fly).arena.x = trxfiledata.circular_arena.arena_center_x;
    trxfiledata.trx(fly).arena.y = trxfiledata.circular_arena.arena_center_y;
    trxfiledata.trx(fly).arena.r = trxfiledata.circular_arena.arena_radius;
end
%end changes
